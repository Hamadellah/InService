...
export default function Favorites() {
  ...
  const availableCount = favoritesList.filter(
    (fav) =>
      fav.availability === true ||
      fav.available === true ||
      fav.availability === 1 ||
      fav.available === 1
  ).length;
      ...
      <div className="mx-auto max-w-[1500px] space-y-7">
          ...
          <div className="relative flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-sm leading-6 text-slate-400 sm:text-base">
                Retrouvez rapidement les professionnels que
                vous avez enregistrés et gardez leurs
                coordonnées toujours à portée de main.
              </p>
            </div>
        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="
            ...
            p-5
            text-[#0d1f1a]
            shadow-[0_14px_35px_rgba(16,185,129,0.18)]
          ">
            <div className="
              absolute
              -bottom-10
        ...
        <section>
          ...
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Retrouvez les coordonnées de vos professionnels
              favoris.
            </p>
          ...
          {!loading && favoritesList.length === 0 && (
            ...
            ">
              ...
              <p className="
                ...
                text-slate-500
              ">
                Ajoutez des techniciens à vos favoris depuis
                la liste des services pour les retrouver
                rapidement ici.
              </p>
